            ...
            <div className="max-w-[614px] p-8 mx-auto h-[calc(100%-84px)] flex flex-col justify-center gap-8">
              ...
              <div className="w-full flex flex-col items-center gap-4">
                ...
                >
                  ...
                  <input
                    className="w-full h-[85px] bg-black text-white mt-8 rounded-[20px] cursor-pointer hover:bg-primary drop-shadow-[0_50px_90px_rgba(0,0,0,0.08)]"
                    type="submit"
                    value={content.btn}
                  />
                  <div className="w-full flex items-center justify-between">
                    <Link href="/forgot-password" legacyBehavior>
                      <a className="font-InterRegular text-base text-secondary underline">
                        {content.p5}
                      </a>
                    </Link>
                    <span className="text-black font-InterRegular text-base">
                      ...
                      <Link href="/join" legacyBehavior>
                        <a className="text-primary underline">{content.p7}</a>
                      </Link>
                    </span>
                  </div>
                </form>
...
export async function getServerSideProps(context) {
  try {
    ...
    const errors = context?.query?.errors ? JSON.parse(context.query.errors) : [];
    return {
      props: {
        header,
        errors,
    ...
    RollbarService.warning(err, context)
  }
}
