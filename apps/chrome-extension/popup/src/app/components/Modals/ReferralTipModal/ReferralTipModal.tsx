...
export default function ReferralTipModal({
  setModal,
}: {
      ...
      <div className={styles['modal__body']}>
        <div ref={modalRef} className={styles['body__container']}>
          ...
          <div className={styles['container__body']}>
            <img
              src={chrome.runtime.getURL('assets/png/referral-tip.png')}
              alt=""
            />
            <div>
              <p className={styles['container__body--p1']}>
                {chrome.i18n.getMessage('referralsModalTitle')}
              </p>
              <p className={styles['container__body--p2']}>
                {chrome.i18n.getMessage('referralsModalDescription')}
              </p>
            </div>
            <button
            ...
            >
              {chrome.i18n.getMessage('referralsModalBtn')}
            </button>
          </div>
        </div>
      </div>
